    ...
    <tbody>
    	...
    	<tr>
            ...
            <div class="entryBtns">
        			...
        			<a class="btn btn-info btn-md pull-right iBtn commentBtn blueBtn" tabindex="0" role="button" data-toggle="popover" title="Comments" data-trigger="focus" data-content="{{ $entry -> notes}} &nbsp;&nbsp;&nbsp; <a href='/notes/{{$entry->id}}/edit'><button class='btn btn-info btn-xs pull-right' type='button'>Edit</button>">  <i class="fa fa-info" aria-hidden="true"></i></a>
        			@else
